...
VHOSTS_DEFAULT_TARGET_CONF="/application/nginx/hosts.d/default.conf"

PROXY_SOURCE_CONF="/config/init/vhost-proxy.conf"
PROXY_TARGET_CONF="/application/nginx/hosts.d/internal-proxy.conf"

PROXY_SOURCE_CONF_HTTPS="/config/init/vhost-proxy-https.conf"
PROXY_TARGET_CONF_HTTPS="/application/nginx/hosts.d/internal-proxy-https.conf"
